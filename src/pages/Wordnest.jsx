    ...
    hard: {
      ...
      clues: {
        across: {
          ...
          3: { num: 3, clue: "City famous for its castle and football team", answer: "NEWCASTLE", row: 9, col: 0 },
          4: { num: 4, clue: "River flowing through the region", answer: "TYNE", row: 11, col: 0 }
        },
        down: {
